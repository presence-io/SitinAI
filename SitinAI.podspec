#
#  Be sure to run `pod spec lint SitinAI.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.description  = "A sdk that contains cv and other AI features, it can do segmentation、face detector etc.."
  ...
  spec.author             = { "TobeYoung" => "yangtaibao@archat.us" }
  # Or just: spec.author    = "TobeYoung"
  # spec.authors            = { "TobeYoung" => "yangtaibao@archat.us" }
  # spec.social_media_url   = "https://twitter.com/TobeYoung"
